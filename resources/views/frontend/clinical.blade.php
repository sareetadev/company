...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
          ...
          <script
            ...
            crossorigin="anonymous"
          ></script>    
    <title>LS Neuro |  Patients & Visitors</title>
</head>
<body>
  ...
  <div class="scroll-btn">
    <a href="#"><span><i class="fa fa-angle-up fa-2x" aria-hidden="true"></i></span></a>
          ...
          <div class="container-fluid mainnav sticky-top c2 ">
            <div class="navbar navbar-expand-lg nnavbar-light">
        ...
        <div class="container-fluid pnvc1 breadcrumb m-0">
            <nav class="breadcrumbEx">
              <h1 class="text-center text-white"> Department</h1>
    ...
    <div class="container-fluid pnvc2">
        ...
        <div class="MainPointTitle">
          <p>Clinical Servie Provided by LSNGH</p>
          </div>
        <div class="row">
          <div class="col-md-4 col-12">
            <ul>
                <li><i class="far fa-check-circle"></i> Neuro Surgery</li>
                <li><i class="far fa-check-circle"></i> Orthopedic</li>
                <li><i class="far fa-check-circle"></i> General Medicine and critical care</li>
                <li><i class="far fa-check-circle"></i> Neonatology & Pediatrics</li>
                <li><i class="far fa-check-circle"></i> Nephrology</li>
                <li><i class="far fa-check-circle"></i> Anesthesiology</li>
                <li><i class="far fa-check-circle"></i> Physiotherapy</li>
                <li><i class="far fa-check-circle"></i> Ophthalmology</li>
                <li><i class="far fa-check-circle"></i> Hemodialysis</li>
                <li><i class="far fa-check-circle"></i> Radiology (MRI/CT/X-Ray/Echo/USG)</li>

            </ul>
          </div>
          <div class="col">
            <ul>
                <li><i class="far fa-check-circle"></i> Neurology</li>
                <li><i class="far fa-check-circle"></i> Maxillofacial</li>
                <li><i class="far fa-check-circle"></i> Gynecology & Obstetrics</li>
                <li><i class="far fa-check-circle"></i> General & Laparoscopic surgery</li>
                <li><i class="far fa-check-circle"></i> Urology</li>
                <li><i class="far fa-check-circle"></i> Dermatology</li>
                <li><i class="far fa-check-circle"></i> Cardiology</li>
                <li><i class="far fa-check-circle"></i> Gastrology</li>
                <li><i class="far fa-check-circle"></i> Endoscopy/Colonoscopy/Rectoscopy</li>
                <li><i class="far fa-check-circle"></i> Pathology</li>
