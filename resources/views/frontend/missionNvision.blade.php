...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
          ...
          <script
            ...
            crossorigin="anonymous"
          ></script>    
    <title>LS Neuro | Vision & Mission</title>
</head>
<body>
  ...
  <div class="scroll-btn">
    ...
    <div class="container-fluid mNv">
    
        <div class="row my-5">
            <div class="col-md-6">
                <img src="image/245531889_2052428041579776_4546355648941241730_n.jpg" alt="img"> 
            </div>
            <div class="col-md-6 my-auto">
              <h1>Our Vision</h1>
                <p>To provide patient-centered health care with inspiring better health in qualityservice & access with supper specialty facilities to all people without compromisingon quality.</p>
            </div>
        </div>
        <div class="row my-5">
            <div class="col-md-6 my-auto">
                <h1>Our Mission</h1>
                <p>A community of people in which all patient achieve their full potential for healthand wellbeing treating with kindness, concern and generosity. We work to betrusted by patients providing the best care and services.</p>
            </div>
            <div class="col-md-6">
                <img src="image/245531889_2052428041579776_4546355648941241730_n.jpg" alt="img"> 
            </div>
        ...
        <div class="row my-5">
            <div class="col-md-6">
                <img src="image/242036151_2031608060328441_4135998142499454341_n.jpg" alt="img"> 
            </div>
            <div class="col-md-6 my-auto">
                <h1>Core Values</h1>
                <p>Team Work: We work together in unity for the fulfillment of L.S. Neuro and General                       Hospital Pvt.Ltd. Vision, Mission andGoals.
                    <br/><br/>Integrity: We commit the principles of the quality of being honesty and truthness                  in our words and actions for caring patients. Our Integrityand ethics will be                  never compromised. Honesty and Integrity in all we say and do .Respect                   and dignity for all humankind.
                    <br/><br/>Excellence: We provide the highest standards of healthcare with super specialty                      facilities for the patient, see the complexity of each patient's life & believe                      that addressing the best way to improve a patient's health.
                    <br/><br/>Respect : We value the uniqueness and dignity of each individual who come to                 L.S. Neuro and General Hospital Pvt. Ltd. can expect polite, friendly helpful                 staff members who related to each person as an individual. We target and                 go the extra mile to meet their expectations.</p>
            </div>
        </div>
