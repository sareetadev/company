...
<body>
  ...
  <div class="scroll-btn">
    <a href="#"><span><i class="fa fa-angle-up fa-2x" aria-hidden="true"></i></span></a>
            ...
            <div class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse"  id="mynavbar">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item active"><a href="career.html" class="nav-link  text-white">Career</a></li>
        ...
        <div class="container-fluid pnvc1 breadcrumb m-0">
            <nav class="breadcrumbEx">
              <h1 class="text-center text-white"> Career</h1>
    ...
    <div class="container-fluid pnvc2">
        ...
        <div class="row">
            <p class="ParaHead">Online Vacancy Registration</p>
            <p>L. S. Neuro and General Hospital Pvt. Ltd. encourages an experienced candidates to drop their CV for any preferred position to the HRD departmenthr@lsneuronepal.com or visit our Hospital. The candidates interested to pursue their carrier in LSNGH must fill up the online application form and also arerequired to upload their CV and the Cover Letter.
            </p>

            <div class="col-12 mt-5">
                <img src="image/careerPic.png" width="100%" alt="">
            </div>
        </div>
    ...
    <div class="container-fluid applyform">
      <div class="row">
        <div class="col-12">Send an Application</div>
        <div class="col">
