...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
          ...
          <script
            ...
            crossorigin="anonymous"
          ></script>
    <title>LS Neuro | Contact Us</title>
</head>
<body>
    ...
    <div class="scroll-btn">
      <a href="#"><span><i class="fa fa-angle-up fa-2x" aria-hidden="true"></i></span></a>
            ...
            <div class="navbar navbar-expand-lg navbar-light ">
                ...
                <div class="collapse navbar-collapse"  id="mynavbar">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item active"><a href="contact.html" class="nav-link  text-white">Contact Us</a></li>
                    </ul>
                </div>
            </div>
          </div>
        ...
        <div class="container-fluid contactc1 breadcrumb m-0">
    ...
    <div class="container-fluid contactc2">
        ...
        <div class="row">
            <div class="col-lg-8 col-12 inputfield1">
              <div class="row my-4">
                <div class="col">
            ...
            <div class="col text-center d-none d-md-none m-auto shortInfo">
              <ul>
                <li><i class="fas fa-phone-alt"></i> 071562897,567,234</li>
                <li><i class="fa fa-envelope" aria-hidden="true"></i> lsneuro@gmail.com</li>
                <li><i class="fas fa-map-marker-alt"></i> Buspark-11, Birgunj</li>
              </ul>
            </div>
        </div>
    </div>
    ...
    <!------------------------------------book appointment Section------------------------------------>
      ...
      <div class="container-fluid contactc3">
        <div class="row">
          <div class="col">
            <h1>Book An Appointment</h1>
          </div>
        </div>
        <div class="row inputfield2">
          ...
          <div class="col-sm-4 my-1 my-sm-3">
            <input type="text" placeholder="Department">
            </div>
      <div class="col-sm-4 my-1 my-sm-3">
            <input type="email" placeholder="Doctor">
            </div>
      <div class="col-sm-4 my-1 my-sm-3">
