...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
          ...
          <script
            ...
            crossorigin="anonymous"
          ></script>    
    <title>LS Neuro | Laboratory</title>
</head>
<body>
  ...
  <div class="scroll-btn">
    ...
    <div class="container-fluid pnvc2">
        ...
        <p>Laboratory Servie Provided by LSNGH</p>
        </div>
        <div class="row">
            <ul>
                <li><i class="far fa-check-circle"></i> Hematology</li>
                <li><i class="far fa-check-circle"></i> Biochemistry</li>
                <li><i class="far fa-check-circle"></i> Serology</li>
                <li><i class="far fa-check-circle"></i> Stool Examination</li>
                <li><i class="far fa-check-circle"></i> Blood Fluid Examination</li>
                <li><i class="far fa-check-circle"></i> Microbiology</li>
            </ul>
