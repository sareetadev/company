...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
          ...
          <script
            ...
            crossorigin="anonymous"
          ></script>
    <title>LS Neuro | News and Events</title>
</head>
<body>
    ...
    <a href="#"><span><i class="fa fa-angle-up fa-2x" aria-hidden="true"></i></span></a>
            ...
            <div class="navbar navbar-expand-lg navbar-light ">
                ...
                <div class="collapse navbar-collapse"  id="mynavbar">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item active"><a href="newsNevents.html" class="nav-link  text-white">News & Event</a></li>
        ...
        <div class="container-fluid pnvc1 breadcrumb m-0">
            <nav class="breadcrumbEx">
              <h1 class="text-center text-white">News and Events</h1>
